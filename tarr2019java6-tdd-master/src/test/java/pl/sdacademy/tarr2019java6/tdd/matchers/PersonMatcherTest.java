...
public class PersonMatcherTest {
    ...
    public void listNotEmptyTest() {
        ...
        // JUnit style
        Assert.assertFalse(personsList.isEmpty());
        //Assert.assertTrue(!personsList.isEmpty());
    ...
    public void harryFriendsLess16yearsOldTest(){
        Assertions.assertThat(ron.getAge()).isLessThan(16);
        Assertions.assertThat(hermiona.getAge()).isLessThan(16);

        // użycie stream
        harryFriends.stream().forEach(
                friend -> Assertions.assertThat(friend.getAge()).isLessThan(16)
        );
